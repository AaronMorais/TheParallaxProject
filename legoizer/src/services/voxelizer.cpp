        ...
        for (size_t j = 0; j < grid[i].size(); ++j)
        {
            for (size_t k = 0; k < grid[i][j].size(); ++k)
            {
                if (grid[i][j][k] != 0)
                {
                    ...
                    faces.push_back(tinyobj::face_t(last+2, last+0, last+3));
                    faces.push_back(tinyobj::face_t(last+2, last+3, last+5));
                    faces.push_back(tinyobj::face_t(last+4, last+1, last+6));
                    faces.push_back(tinyobj::face_t(last+4, last+6, last+7));
                    faces.push_back(tinyobj::face_t(last+2, last+4, last+5));
                    faces.push_back(tinyobj::face_t(last+5, last+7, last+4));
                    faces.push_back(tinyobj::face_t(last+0, last+3, last+1));
                    faces.push_back(tinyobj::face_t(last+3, last+6, last+1));
                    faces.push_back(tinyobj::face_t(last+5, last+7, last+6));
                    faces.push_back(tinyobj::face_t(last+5, last+6, last+3));
                }
            }
        }
    }
